...
class Migration_20180706123620 extends Migration implements IMigration
{
    ...
    public function up()
    {
        $this->setLocalization('ger', 'account data', 'emailAlreadyExists', 'Zu der von Ihnen eingegebenen E-Mail-Adresse existiert bereits ein Kundenkonto in unserem Shop. Wenn Sie die Bestellung mit Ihrem vorhandenen Kundenkonto abschließen möchten, melden Sie sich bitte mit Ihrer E-Mail-Adresse und Ihrem Passwort an. Wenn Sie als Gast fortfahren möchten, deaktivieren Sie die Option "Neues Kundenkonto erstellen".');
